-- Apply changes that were previously added to the already released V2 migration.
...
VALUES
    (6601, 6501, FALSE, '하늘이는 별빛 숲에서 작은 친구를 만났어요.', 1, '2026-07-20 16:00:00', '2026-07-20 16:02:00'),
    (6602, 6502, FALSE, '서아는 구름 우체국에 편지를 전해 주었어요.', 1, '2026-07-15 16:00:00', '2026-07-15 16:03:00'),
