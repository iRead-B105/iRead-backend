...
class WordAttemptScoreCalculatorTest {
    ...
    void 정확한_첫_응시는_1000점이다() {
        int score = calculator.calculate("사과", " 사과! ", true, false, 0, true);

        assertThat(score).isEqualTo(1000);
    }

    @Test
    void 재응시_STT불일치_오답은_각각_감점한다() {
        int score = calculator.calculate("사과", "바나나", true, false, 2, false);
    ...
    void 모든_감점을_적용해도_0점_미만으로_내려가지_않는다() {
        int score = calculator.calculate("사과", null, false, true, 10, false);
